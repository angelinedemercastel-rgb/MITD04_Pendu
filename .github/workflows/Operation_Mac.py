...
#---------- Rajout---------
import os
cheminFichier = os.path.join(os.path.dirname(__file__), "listeDeMots.txt")
cheminFichierScore = os.path.join(os.path.dirname(__file__), "fichierScore.txt")
#---------------------------
...
def lireListeMots(chemin) :
    print("Chemin", chemin)
    file=open(chemin, "r", encoding="utf-8") # changement en utf-8
