...
def menu_principal():
    ...
    Button(accueil, text="Jouer", width=20, height=2,
           command=lambda: [accueil.destroy(), ouvrir_jeu()],bg="#ECEFF1").pack(pady=20)

    Button(accueil, text="Ajouter un mot", width=20, height=2,
           command=ajouterMot,bg="#ECEFF1").pack(pady=20)

    Button(accueil, text="Règles du jeu", width=20, height=2,
           command=afficheRegles,bg="#ECEFF1").pack(pady=20)

    Button(accueil, text="Scores", width=20, height=2,
           command=ouvreFichierScore,bg="#ECEFF1").pack(pady=20)

    Button(accueil, text="Quitter", width=20, height=2,
           command=fen.destroy,bg="#ECEFF1").pack(pady=20)
